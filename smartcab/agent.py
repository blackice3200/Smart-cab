...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon=math.cos(math.radians(0.1*self.trial))
    ...
    def get_maxQ(self, state):
        ...
        # i have returned only the best actions which they have the highest value only
        return actions 
...
def run():
    ...
    sim = Simulator(env,log_metrics=True,optimized=True,display=False,update_delay=0)
